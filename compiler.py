import bytecode, objects, errors, prelude
...
class Context(object):
    ...
    # Export to Rantime class
    def import_prelude(self, context):
        index = context.register_variable("print")
        context.variables[index] = objects.Variable("print",objects.ExternalFunction("print",prelude.print_fn,1))
        
        index = context.register_variable("readline")
        context.variables[index] = objects.Variable("readline",objects.ExternalFunction("readline",prelude.readline,1))
